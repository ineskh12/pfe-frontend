      ...
      <div>
        <nav className="blue darken-3">
          <div className="nav-wrapper">
            ...
            <li><Link to="/DnDWeviooReact/template"><i className="fa fa-users"></i> Meetups</Link></li>  
            <li><Link to="/DnDWeviooReact/list"><i className="fa fa-plus"></i> Add Meetup</Link></li>  
